...
struct futhark_i8_2d *futhark_new_raw_i8_2d(struct futhark_context *ctx, cl_mem data, int64_t dim0, int64_t dim1);
...
cl_mem futhark_values_raw_i8_2d(struct futhark_context *ctx, struct futhark_i8_2d *arr);
