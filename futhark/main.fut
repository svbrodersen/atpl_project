...
def simulate [n] (num_qubits: i64) (gates: [n](i64, i64, i64)) : ([][]i8, []i8) =
...
entry main [n] (num_qubits: i64) (gates: [n](i64, i64, i64)) : ([]t) =
  let (_, measurements) = trace (simulate num_qubits gates)
  in measurements
